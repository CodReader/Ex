...
/**
 * The table class for the &quot;foo&quot; database table.
 *
...
public class FooTable extends BaseTable<FooTable> {
    ...
    public final Column<FooTable, Integer> modelSpeed = createColumn(
    ...
    public final Column<FooTable, Integer> status = createColumn(
            "status", Integer.class, Types.INTEGER, Column.FLAG_DEFAULT);
    public final Column<FooTable, Long> statusByUserId = createColumn(
            "statusByUserId", Long.class, Types.BIGINT, Column.FLAG_DEFAULT);
    public final Column<FooTable, String> statusByUserName = createColumn(
            "statusByUserName", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
    public final Column<FooTable, Date> statusDate = createColumn(
            "statusDate", Date.class, Types.TIMESTAMP, Column.FLAG_DEFAULT);

    private FooTable() {
        super("foo", FooTable::new);
    }
